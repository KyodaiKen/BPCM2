...
//
// In a bz2 stream or stream, there is never any bit padding except for 0..7
// bits in the final byte in the stream. Successive compressed blocks in a
// .bz2 stream are not byte-aligned.
//
//
...
namespace PCM.BZip2
{
    internal class BZip2Compressor
    {
        ...
        ///            byte c would require the start of a new run, and
        ...
        public void CompressAndWrite() // endBlock
        {
             ...
             * bits. For a compressed stream of size 100Gb -- about 100000 blocks --
