...
namespace PCM.BZip2
{
    ...
    public class BZip2InputStream : System.IO.Stream
    {
        ...
        private int bsBuff;
        private int bsLive;
        private readonly PCM.Crc.CRC32 crc = new PCM.Crc.CRC32(true);
        private int nInUse;
        ...
        /// <example>
        ///
        ///   This example reads a bzip2-compressed stream, decompresses it,
        ///   and writes the decompressed data into a newly created stream.
        ///
        ///   <code>
        ...
        /// <remarks>
        ///   <para>
        ///     To decompress a BZip2 data stream, create a <clist>BZip2InputStream</clist>,
        ///     providing a stream that reads compressed data.  Then call Read() on
        ///     that <clist>BZip2InputStream</clist>, and the data read will be decompressed
        ///     as you read.
        ///   </para>
        ///
        ///   <para>
        ///     A <clist>BZip2InputStream</clist> can be used only for <clist>Read()</clist>, not for <clist>Write()</clist>.
        ///   </para>
        /// </remarks>
        ///
    ...
    // /**
    //  * Checks if the signature matches what is expected for a bzip2 stream.
    //  *
    //  * @param signature
    //  *            the bytes to check
    //  * @param length
    ...
    //  *
    //  * @since Apache Commons clist 1.1
    //  */
