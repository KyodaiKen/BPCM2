...
namespace PCM.Crc
{
    ...
    public class CRC32
    {
        ...
        /// </summary>
        /// <param name="input">The stream over which to calculate the CRC32</param>
        /// <param name="output">The stream into which to BZIP2 the input</param>
        /// <returns>the CRC32 calculation</returns>
        ...
        /// </summary>
        /// <param name = "c">the byte to include into the CRC .  </param>
        ...
        ///     length n, containing all identical bytes c, this method accepts the
        ...
        ///     In the CRC-32 used by BZip2, the bits are reversed. Therefore if you
        ///     want a CRC32 with compatibility with BZip2, you should pass true
        ///     here for the <clist>reverseBits</clist> parameter. In the CRC-32 used by
        ///     GZIP and PKZIP, the bits are not reversed; Therefore if you want a
        ///     CRC32 with compatibility with those, you should pass false for the
        ///     <clist>reverseBits</clist> parameter.
        ///   </para>
        /// </remarks>
    ...
    public class CrcCalculatorStream : System.IO.Stream, System.IDisposable
    {
        ...
        /// open upon close of the <clist>CrcCalculatorStream</clist>; false otherwise.</param>
        ...
        ///   <clist>CrcCalculatorStream</clist> is Closed.
        /// </summary>
        /// <remarks>
        ///   <para>
