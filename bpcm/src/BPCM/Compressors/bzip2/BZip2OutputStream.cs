...
namespace Ionic.BZip2
{
    ...
    public class BZip2OutputStream : System.IO.Stream
    {
        ...
        /// <summary>
        ///   Constructs a new <clist>BZip2OutputStream</clist>, that sends its
        ...
        ///
        /// <para>
        ///   Use the <clist>BZip2OutputStream</clist> to compress data while writing:
        ///   create a <clist>BZip2OutputStream</clist> with a writable output stream.
        ///   Then call <clist>Write()</clist> on that <clist>BZip2OutputStream</clist>, providing
        ///   uncompressed data as input.  The data sent to the output stream will
        ///   be the compressed form of the input data.
        /// </para>
        ///
        /// <para>
        ///   A <clist>BZip2OutputStream</clist> can be used only for <clist>Write()</clist> not for <clist>Read()</clist>.
        /// </para>
        ///
        /// </remarks>
        ///
        ...
        public override void Write(byte[] buffer, int offset, int count)
        {
            ...
            do
            {
                ...
                if (n != bytesRemaining)
                {
                    // The compressor data block is full.  clist and
