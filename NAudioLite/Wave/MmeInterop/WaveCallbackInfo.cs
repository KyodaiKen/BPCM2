...
namespace NAudioLitle.Wave
{
    ...
    public class WaveCallbackInfo
    {
        ...
        public void Connect(WaveInterop.WaveCallback callback)
        {
        ...
        public MmResult WaveOutOpen(out IntPtr waveOutHandle, int deviceNumber, WaveFormat waveFormat, WaveInterop.WaveCallback callback)
        {
            MmResult result;
